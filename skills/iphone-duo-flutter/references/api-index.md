...
> **Verify signatures before you ship.** Apple has now published *Preparing
> your app for iPhone Duo*, and Xcode 27.1 beta is available. Confirm spellings,
> argument labels, and availability against the current Apple documentation and
> the SDK headers installed with your Xcode version before relying on a build.
...
| Detect a vertical bar | `toolbarVerticalEdge` environment value | `verticalBarEdge` trait |
