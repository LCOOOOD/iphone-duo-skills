...
- [Preparing your app for iPhone Duo](https://developer.apple.com/documentation/technologyoverviews/preparing-your-app-for-iphone-duo)
  — now published. Covers resizing, vertical bars, arrangement views, reserved
  regions, and camera handling, with current SwiftUI and UIKit API names.
...
Re-checked September 23, 2026. Xcode 27.1 beta is available, including the
iPhone Duo simulator, and *Preparing your app for iPhone Duo* is live. Treat the
current Apple documentation and the SDK headers installed with your Xcode
version as authoritative when a name or signature differs from these notes.

## Keeping this current

Re-run the research when Apple updates Xcode 27.1 or the related documentation.
The Tech Talk pages carry a WebVTT subtitle track in their HLS manifest, which
is the most reliable way to read a talk in full — see
